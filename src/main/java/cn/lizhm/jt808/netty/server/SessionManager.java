...
public class SessionManager {
	...
	// public synchronized void removeServer(String sessionId) {
	// if (sessionId == null)
	// return;
	// Session session = sessionIdMap.removeServer(sessionId);
	// if (session == null)
	// return;
	// if (session.getTerminalPhone() != null)
	// this.phoneMap.removeServer(session.getTerminalPhone());
	// try {
